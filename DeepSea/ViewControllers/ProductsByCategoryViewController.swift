...
class ProductsByCategoryViewController: UIViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
        let developing = Developing(frame: .zero, sectionName: "Por Categoria", colorView: UIColor(named: "deepBlue") ?? .white)
